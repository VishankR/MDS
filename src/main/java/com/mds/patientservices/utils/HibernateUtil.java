package com.mds.patientservices.utils;
...
/*			StandardServiceRegistry standardRegistry = new StandardServiceRegistryBuilder()
			...
			//2. When specifying all properties in "hibernate.properties"
			/*
			 * StandardServiceRegistry registry = new
			 * StandardServiceRegistryBuilder().configure().build(); MetadataSources sources
			 * = new MetadataSources(registry); Metadata metadata =
